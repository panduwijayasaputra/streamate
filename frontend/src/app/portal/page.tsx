          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                ...
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
              >
            ...
            <div className="flex items-center space-x-6">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl flex items-center justify-center">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center px-4 py-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <button className="w-full flex items-center px-4 py-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div>
                  <p className="font-medium text-gray-900">Start Streaming</p>
                  <p className="text-sm text-gray-500">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">AI Settings Updated</p>
                <p className="text-sm text-gray-500">
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Stream Ended</p>
                <p className="text-sm text-gray-500">
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Character Changed</p>
                <p className="text-sm text-gray-500">
